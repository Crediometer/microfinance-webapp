...
const AddCashModal = ({createModal, setCreateModal}: any) => {
            ...
            >
                ...
                <form>
                    <Card>
                        ...
                        >
                            <Typography.Text>Amount To Add</Typography.Text><br></br>
                            <Input
                                style={{
                                    width:"100%",
                                    marginTop:"10px",
                        ...
                        >
                            <Typography.Text>Source</Typography.Text><br></br>
                            <Select
                                style={{
                                    width:"100%",
                                    marginTop:"10px",
