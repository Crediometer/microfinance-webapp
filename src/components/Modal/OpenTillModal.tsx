...
const OpenTillModal = ({createModal, setCreateModal}: any) => {
        ...
        <>
            ...
            >
                ...
                <form>
                    <Card>
                        ...
                        >
                            <Typography.Text>Teller ID</Typography.Text><br></br>
                            <Select
                                style={{
                                    width:"100%",
                                    marginTop:"10px",
                        ...
                        >
                            <Typography.Text>Initial Cash Amount</Typography.Text><br></br>
                            <Input
                                style={{
                                    width:"100%",
                                    marginTop:"10px",
            ...
            {confirmModal && (
                <SuccessModal
                    ...
                    title="Till Opened Successfully"
                />
            )}
        </>
    );
