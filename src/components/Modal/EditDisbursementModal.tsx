...
const EditDisbursementModal = ({depositModal, setDepositModal}: any) => {
        ...
        <>
            ...
            >
                <Typography.Title style={{
                    ...
                    color:"#070707E5",
                    fontSize:"20px"
                }}>Edip Pending Request</Typography.Title>
                <Typography.Title style={{
                    textAlign: "center",
                    color:"#231F2099",
                    fontSize:"16px"
            ...
            {confirmModal && (
                <ConfirmModal 
                    ...
                    type="create"
                    text="Edit Request"
                    content="Are you sure you want to edit this user request"
                    label="Yes Edit"
                />
            )}
        </>
