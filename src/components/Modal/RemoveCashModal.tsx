...
const RemoveCashModal = ({createModal, setCreateModal}: any) => {
        ...
        <>
            ...
            >
                ...
                <form>
                    <Card>
                        ...
                        >
                            <Typography.Text>Amount TO Remove</Typography.Text><br></br>
                            <Input
                                style={{
                                    width:"100%",
                                    marginTop:"10px",
                        ...
                        >
                            <Typography.Text>Destination</Typography.Text><br></br>
                            <Select
                                style={{
                                    width:"100%",
                                    marginTop:"10px",
            ...
            {confirmModal && (
                <SuccessModal
                    ...
                    title="Remove Cash Successfully"
                />
            )}
        </>
    );
